...
function BookItem({ book, imageBaseUrl }) {
    return (
        <div className="col-md-6">
            <div className="row p-2 bg-white border rounded mt-2 position-relative" style={{marginRight: '1px', height:'200px'}}>
                ...
                <div className="align-items-center align-content-center col-md-3 border-left mt-1">
                    ...
                    <button className="btn btn-outline-success btn-sm mt-2 add-to-wishlist" data-id={book.id} type="button"><i className="far fa-heart"></i></button>
                    </div>
                </div>
            </div>
        </div>
